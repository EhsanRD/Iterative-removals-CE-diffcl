library("memoise")
FigGenDf<-function(Tp,N_s,m,rho0,r,type,c,k,kprim,p,pprim,g,gprim,effsiz,accept_pwr) {
  
  IterRes<- IterRemove_diffcl_CE(Tp,N_s,m,rho0,r,type,c,k,kprim,p,pprim,g,gprim,effsiz,accept_pwr)
